...
class Stage4Layout(QWidget):
    ...
    def __init__(self):
        ...
        self.init_ui()
        self.stageNumber = 4
        self.stage_answer = "905"
        
    def init_ui(self):
        # Créer le label d'en-tête du niveau 4
        headerLabel = QLabel("Stage 4")
        headerFont = QFont("Arial", 20, QFont.Weight.Bold)
        headerLabel.setFont(headerFont)

        # Créer le label d'instruction du niveau 4
        instructionLabel = QLabel("Je suis composé de <b>lettres</b> puis de <b>chiffres</b>, mais je suis invisible à tes yeux. Et ma somme est le mot de passe, crois-moi c'est <b>sérieux</b>. Ma longueur est la clé, mais pas celle d'un cadenas. Alors regroupe mes fragments et la porte s'ouvrira à toi.")
        instructionLabel.setFont(QFont("Arial", 12))
        instructionLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        instructionLabel.setWordWrap(True)

        # Consigne
        textToDecode = "Trouvez le code caché derrière ces mots."
