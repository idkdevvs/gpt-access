...
class Stage5Layout(QWidget):
    ...
    def init_ui(self):
        ...
        # Créer le label d'en-tête du niveau 5
        headerLabel = QLabel("Stage 5")
        headerFont = QFont("Arial", 20, QFont.Weight.Bold)
        headerLabel.setFont(headerFont)

        # Créer le label d'instruction du niveau 5
        instructionLabel = QLabel("Vous ramassez un document intitulé Tokopisco comme vous en avez déjà vu : sûrement un autre morceau de carte.")
